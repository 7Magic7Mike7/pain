...
OUT_PATH = os.path.join(BASE_PATH, "actual", "temperature_anomalies.csv")
...
def normalize_temperature_dataset(dataframe: pd.DataFrame, painorigin: str = "EnvNat") -> pd.DataFrame:
